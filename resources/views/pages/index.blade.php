        ...
        <nav class="navbar navbar-expand-lg bg-light shadow-lg">
            <div class="container">
                <a class="navbar-brand" href="index.blade.php">
                    <img src="{{(@$main->icon_img)?url($main->icon_img):asset("assets/images/logo.png")}}" class="logo img-fluid" alt="Kind Heart Charity">
                    <span>
                        {{(@$main->ic_title)?$main->ic_title:"THE NEW ERA"}}
                        <small>{{(@$main->ic_sub_title)?$main->ic_sub_title:"THE NEW ERA"}}</small>
                    </span>
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item" href="news.blade.php">News Listing</a></li>

                                <li><a class="dropdown-item" href="news-detail.blade.php">News Detail</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item ms-3">
                            <a class="nav-link custom-btn custom-border-btn btn" href="donate.blade.php">Donate</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div id="hero-slide" class="carousel carousel-fade slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{(@$main->bc_img)?url($main->bc_img):asset("assets/images/one.jpg")}}" class="carousel-image img-fluid" alt="...">

                                        <div class="carousel-caption d-flex flex-column justify-content-end">
                                            <h1 style="font-size: 22px; color: teal;">{{ (@$main->title) ? $main->title : 'THE NEW ERA' }}</h1>
                                            <p>{{(@$main->sub_title)?$main->sub_title:"THE NEW ERA BEGINS"}}</p>
                                        </div>
                                    </div>

                                    <div class="carousel-item">
                                        <img src="{{(@$main->bc_imga)?url($main->bc_imga):asset("assets/images/two.jpg")}}" class="carousel-image img-fluid" alt="...">
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{(@$main->bc_imgb)?url($main->bc_imgb):asset("assets/images/three.jpg")}}" class="carousel-image img-fluid" alt="...">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 text-center mx-auto">
                            <h2 class="mb-5">Welcome to UCPC</h2>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <img src="images/one.jpg" class="custom-text-box-image img-fluid" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-5 col-12">
                            <img src="images/three.jpg" class="about-image ms-lg-auto bg-light shadow-lg img-fluid" alt="">
                        </div>
            ...
            <section class="volunteer-section section-padding" id="section_4">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="images/two.jpg" class="volunteer-image img-fluid" alt="">
